...
/* Define username and associated password array */$logins = array('Rachid' => '123456','username1' => 'password1','username2' => 'password2');
...
header("location:http://www.dinewadonia.ga/Menu.php");
exit;
} else {
